...
ARGS = ["prog", "--stylesheet", "file:tests/data/margin-label.json"]


def test_that_it_supports_margin_space_specification_for_labels():
    input_lines = [
        "toRight whatever",
        "toTheRight whatever",
        "veryLongLongLongLongLongLongLongLabel macro",
        "veryLongLongLongLongLongLongLongLabel ;comment",
    ]
